...
import { Card, CardGrid, Tabs, TabItem, Badge, Steps } from '@astrojs/starlight/components';

<Badge text="ESP-IDF" variant="tip" size="large" />
<Badge text="HLK-LD2420" variant="note" size="large" />
<Badge text="MQTT" variant="success" size="large" />
<Badge text="Active Development" variant="caution" size="large" />
...
3. **Configure Project Settings**
   ...
   **Critical Configuration Items:**
   ...
   Navigate to: **Application Configuration → GPIO Configuration**
